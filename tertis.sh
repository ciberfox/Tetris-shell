...
update_score() {
    ...
    set_bold
    set_fg $SCORE_COLOR
    xyprint $SCORE_X $SCORE_Y         "Linee completate: $lines_completed"
    xyprint $SCORE_X $((SCORE_Y + 1)) "Livelllo:           $level"
    xyprint $SCORE_X $((SCORE_Y + 2)) "Punteggio:           $score"
    reset_colors
}

help=(
"  usa le frecce cursore"
"       oppure"
"      s: Su"
"a: Sinistra,  d: Destra"
"    spazio: caduta"
"      q: esce"
"  c: disabilita colori"
"n: disabilita visuale prossimo pezzo"
"h: disabilita questo help"
)
